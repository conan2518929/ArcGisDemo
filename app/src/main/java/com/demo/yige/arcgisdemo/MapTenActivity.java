...
import com.demo.yige.arcgisdemo.adapter.SpinnerAdapter;
...
public class MapTenActivity extends AppCompatActivity {

    private MapView mMapView;
    private LocationDisplay mLocationDisplay;
    private Spinner mSpinner;
    private Button small,big;
...
//        Log.i("2TAG",mLocationDisplay.getLocation().getPosition().getY()+"");
        ...
        mLocationDisplay.addDataSourceStatusChangedListener(new LocationDisplay.DataSourceStatusChangedListener() {
            ...
            public void onStatusChanged(LocationDisplay.DataSourceStatusChangedEvent dataSourceStatusChangedEvent) {
                ...
                boolean permissionCheck1 = ContextCompat.checkSelfPermission(MapTenActivity.this, reqPermissions[0]) ==
                        PackageManager.PERMISSION_GRANTED;
                boolean permissionCheck2 = ContextCompat.checkSelfPermission(MapTenActivity.this, reqPermissions[1]) ==
                        PackageManager.PERMISSION_GRANTED;

                if (!(permissionCheck1 && permissionCheck2)) {
                    // If permissions are not already granted, request permission from the user.
                    ActivityCompat.requestPermissions(MapTenActivity.this, reqPermissions, requestCode);
                } else {
                    // Report other unknown failure types to the user - for example, location services may not
                    // be enabled on the device.
                    String message = String.format("Error in DataSourceStatusChangedListener: %s", dataSourceStatusChangedEvent
                            .getSource().getLocationDataSource().getError().getMessage());
                    Toast.makeText(MapTenActivity.this, message, Toast.LENGTH_LONG).show();
        ...
        SpinnerAdapter adapter = new SpinnerAdapter(MapTenActivity.this, R.layout.spinner_layout, R.id.txt, list);
...
//                        Log.i("1TAG","开始定位");
//                        Log.i("1TAG",mMapView.getY()+"");
//                        Log.i("1TAG",mMapView.getX()+"");
                        break;
                    case 2:
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(MapTenActivity.this, getResources().getString(R.string.location_permission_denied), Toast
                    .LENGTH_SHORT).show();
