...
public class MapSaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oauthLoginManager = MapNineActivity.getOAuthLoginManagerInstance();
                    ...
                    portal.addDoneLoadingListener(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (portal.getLoadStatus() == LoadStatus.LOADED) {
                                ...
                                final ListenableFuture<PortalItem> saveAsFuture = MapNineActivity.mMap.saveAsAsync(portal, null, mTitle, mTagsList, mDescription, null, true);
